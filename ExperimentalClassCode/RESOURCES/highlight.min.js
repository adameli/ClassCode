...
;hljs.registerLanguage("python-repl",a)})();/*! `scss` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("php-template",n)})();/*! `csharp` grammar compiled for Highlight.js 11.7.0 */
